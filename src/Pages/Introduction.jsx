    ...
    <>
      ...
      >
        <div className="w-1/2">
            ...
            <motion.h2 initial={{y:300}} animate={{y:0}} transition={{delay:2.4, duration:0.4, type:"spring" }} className=" mt-16 text-4xl text-whitee ubuntu">I am <span className="coolfont mr-2 text-redd">Mohd Bilal</span>, a B.Tech student deeply passionate about<br /><span className=" tracking-widestestcum ">web development</span>, I embody a genuine <span className=" tracking-widestestcum ">enthusiasm</span>  for crafting exceptional digital experiences.</motion.h2>
            <motion.div initial={{y:320}} animate={{y:0}} transition={{delay:2.45, duration:0.5, type:"spring" }} className="w-full mt-12 grid grid-flow-col smartphone:grid-flow-row"> 
            ...
            <img className="w-full h-full translate-x-20 rounded-lg grayscale hover:grayscale-0 transition-all duration-700" src={pfp} alt="" />
            </motion.div>
        </div>
      </motion.section>
    </>
