...
export function Skills() {
  ...
  return (
    <>
      <m.section initial={{opacity:0}} animate={{opacity:1}} transition={{ delay: 0.75, duration: 0.50, ease:"easeInOut" }} className=" w-11/12 smartphone:w-full h-screen mx-auto flex flex-col justify-start ite text-whitee">
        <div id="heading" className="text-7xl smartphone:text-6xl smartphone:text-center mt-5 ubuntu">
          <h1 className="smartphone:text-center">
            My Skill <span className="text-accent">{'"Stack"'}</span>  
          </h1>
