    ...
    <>
      <m.section initial={{opacity:0}} animate={{opacity:1}} transition={{ delay: 0.75, duration: 0.50, ease:"easeInOut" }} className="laptop:h-full w-11/12 smartphone:w-full h-full mx-auto flex flex-col justify-start  text-w1">
        ...
        transition={{
          ...
          <button
            onClick={popSkill}
            className="flex group justify-center items-center  h-fit mx-auto smartphone:mx-4 py-4 laptop:py-2  px-14 rounded-2xl text-bg2 tracking-wide bg-w1 font-semibold transition-all duration-500  hover:translate-y-[-4px] hover:rounded-xl hover:shadow-[4px_4px_0px_white] shadow-sm shadow-w1 active:translate-x-[0px] active:translate-y-[0px] active:rounded-2xl active:shadow-none drop-shadow-2xl">
            pop(<span className="transition-all duration-700 group-hover:text-accent2lt px-1 ">skill</span>) <UploadSimple size={"100%"} className="mx-5 w-10 laptop:w-8 smartphone:mx-1 group-hover:-translate-y-1 transition-all duration-500" />
          </button>
          <button
            onClick={pushSkill}
            className="flex group justify-center items-center h-fit mx-auto smartphone:mx-4 py-4 laptop:py-2 px-14 rounded-2xl text-bg2 tracking-wide bg-w1  font-semibold transition-all duration-500 hover:translate-y-[4px] hover:rounded-xl hover:shadow-[4px_4px_0px_white] shadow-sm shadow-w1 active:translate-x-[0px] active:translate-y-[0px] active:rounded-2xl active:shadow-none">
            push(<span className="transition-all duration-700 group-hover:text-accent2lt px-1">skill</span>) <DownloadSimple size={"100%"} className="mx-5 w-10 laptop:w-8 smartphone:mx-1 group-hover:translate-y-1 transition-all duration-500"/>
          </button>
        </m.div>
        <section
          id="stack"
