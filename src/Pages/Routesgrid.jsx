    ...
    <>
      <LazyMotion features={domAnimation}>
        <m.div
          ...
          className="app2 bg-cp2bg3  h-screen w-screen grid grid-cols-8 grid-rows-8 gap-3 smartphone:p-5 smartphone:mt-24 smartphone:flex flex-col"
        >
          <Link
            to="/Introduction"
          ...
          >
            <m.section variants={animation}
              ...
              id="abt"
              className="bg-gradient-to-br from-cp2bg1 to-cp2bg2 group h-full text-cp2bg4 flex justify-between items-center rounded-sm hover:rounded-xl transition-all duration-500 ease-in-out"
            >
              <div className="flex flex-col smartphone:my-3 smartphone:items-center smartphone:justify-center">
                ...
                >
                  About <span className="text-cp2accent">Me!</span>
                </h1>
                <h2
                ...
                >
                  ...
                  <ArrowCircleRight
                    size={32}
                    className={`text-cp2accent opacity-85 transition-all ease-in-out duration-300 group-hover:translate-x-3`}
                    weight="duotone"
                  />
                </h2>
              </div>
          ...
          >
            <m.section
              ...
              id="skills"
              className="group bg-gradient-to-bl from-cp2bg1 to-cp2bg2 text-w2 h-full flex flex-col rounded-sm hover:rounded-xl transition-all duration-500 ease-in-out"
            >
              <h1
              ...
              >
                Skill <span className="text-cp2accent">Stack</span>
              </h1>
              <h2
              ...
              >
                ...
                <ArrowCircleRight
                  className={`text-cp2accent transition-all ease-in-out duration-300 group-hover:translate-x-2`}
                  size={32}
                  weight="duotone"
                />
              </h2>
          ...
          >
            <m.section
              ...
              id="projects"
              className="group bg-gradient-to-tr from-cp2bg1 to-cp2bg2 text-w2 flex flex-col h-full row-start-5 col-start-2 col-span-2 row-span-3 rounded-sm hover:rounded-xl transition-all duration-500 ease-in-out"
            >
              <h1
              ...
              >
                X-<span className="text-cp2accent">Tras</span>
              </h1>
              <h2
              ...
              >
                Stuff that I&#x27;m into
                <ArrowCircleRight
                  className={`text-cp2accent opacity-85 transition-all ease-in-out duration-300 group-hover:translate-x-2`}
                  size={32}
                  weight="duotone"
                />
              </h2>
          ...
          <m.section
            ...
            id="Work"
            className="group h-full bg-gradient-to-br from-cp2bg2 to-cp2bg1 text-w1  flex flex-col justify-center rounded-sm hover:rounded-xl transition-all duration-500 ease-in-out"
          >
            <div className="flex flex-col smartphone:my-3 smartphone:justify-center">
                <h1
                  ...
                  group-hover:translate-x-3 transition-all duration-300 ease-in-out ubuntu`}
                >
                  My <span className="text-cp2accent">Work</span>
                </h1>
                <h2
