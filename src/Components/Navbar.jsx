    ...
    return(
        ...
        className="w-screen h-nav backdrop-blur-xl pb-1 text-white flex tablet:flex-col justify-between items-center sticky top-0">
            ...
            <ul className="flex items-center backdrop-blur-lg">
                ...
                <li className="h-full my-3 backdrop-brightness-200 text-black ubuntu transition-all ease-in-out duration-700 hover:text-black hover:bg-watspp w-full bg-whitee rounded-full overflow-hidden"><a href="/Resume (4).pdf" download className="flex gap-1  items-center text-md smartphone:pr-2 pl-2">Download resume<Download className="bg-watspp p-1 smartphone:hidden" size={32} weight="duotone" /></a></li>
            </ul>
        </motion.nav>
        </div>
    )
