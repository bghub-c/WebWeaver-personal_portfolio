    ...
    return(
        ...
        className="w-screen h-nav backdrop-blur-xl pb-1 text-white flex tablet:flex-col justify-between items-center sticky top-0">
            ...
            <ul className="flex items-center backdrop-blur-lg">
                <li className="h-full w-1/5 m-3 backdrop-brightness-200 text-white transition-all ease-in-out duration-200 hover:scale-105 hover:-translate-y-1 hover:text-insta p-3/4"> <a target="_blank" href="https://www.instagram.com/mohd.bilal__?igsh=MW9ydDcwcTR4dmVjaQ=="> <InstagramLogo size={32} weight="duotone" /> </a></li>
                <li className="h-full w-1/5 m-3 backdrop-brightness-200 text-white transition-all ease-in-out duration-200 hover:scale-105 hover:-translate-y-1 hover:text-lnkin  p-3/4"> <a target="_blank" href="https://www.linkedin.com/in/mohd--bilal--?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><LinkedinLogo size={32} weight="duotone" /> </a></li>
                <li className="h-full w-1/5 m-3 backdrop-brightness-200 text-white transition-all ease-in-out duration-200 hover:scale-105 hover:-translate-y-1 hover:text-zinc-500  p-3/4"> <a target="_blank" href="https://github.com/bghub-c"><GithubLogo size={32} weight="duotone" /> </a></li>
                <li className="h-full w-1/5 m-3 backdrop-brightness-200 text-white transition-all ease-in-out duration-200 hover:scale-105 hover:-translate-y-1 hover:text-blue-500  p-3/4"> <a target="_blank" href=""><TwitterLogo size={32} weight="duotone" /> </a></li>
