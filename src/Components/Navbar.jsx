...
export function Navbar({loc}){
    return(
        ...
        className={`w-screen h-nav backdrop-brightness-75 pb-2 ${loc?"text-w1":"text-bg1"}  flex tablet:flex-col smartphone:flex-col justify-between items-center sticky top-0`}>
