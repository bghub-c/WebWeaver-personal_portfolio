...
export function Home() {
  ...
  return (
    <>
      <motion.section
        className="w-full h-full laptop:m-0 z-20 grid grid-rows-2 backdrop-blur-sm backdrop-brightness-100 hover:rounded-2xl duration-200 border-l overflow-hidden border-accentylt transition-all"
        initial={{
          scale:0,
          y:-2000
        }}
