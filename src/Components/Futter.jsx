...
export function Futter({loc}){
    ...
    console.log(loc)
return(
    <div className={`${loc?"w-11/12 mt-5 border-y bg-bk text-whitee":" bg-black text-bk "} mx-auto border-whitee h-fit flex  justify-center`}>
    <section  id="Footer" className="flex justify-between items-center smartphone:flex-col  border-white mb-4  w-8/12 smartphone:w-full">
        ...
        <ul className="flex smartphone:justify-center ">
            <li className="h-full w-1/5 mr-3 backdrop-brightness-200  transition-all ease-in-out duration-200 hover:scale-105 hover:-translate-y-1 hover:text-insta p-3/4"><InstagramLogo size={32} weight="duotone" /></li>
            <li className="h-full w-1/5 mx-3 backdrop-brightness-200  transition-all ease-in-out duration-200 hover:scale-105 hover:-translate-y-1 hover:text-lnkin  p-3/4"><LinkedinLogo size={32} weight="duotone" /></li> 
        </ul>
