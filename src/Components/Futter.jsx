...
return(
    ...
    <section  id="Footer" className="flex justify-between items-center smartphone:flex-col  border-white mb-4  w-8/12 smartphone:w-full">
        ...
        <m.h1 initial={{y:10, opacity:0.5 }} whileInView={{y:0, opacity:1}} transition={{delay:0.6, type:"tween"}} className="flex smartphone:flex-col smartphone:text-7xl items-end smartphone:items-center text-8xl ubuntu">Drop a hello!<HandWaving className="transition-colors duration-300 ml-2 smartphone:hidden  group-hover:text-yellow-400" size={100} weight="duotone" /></m.h1>
        <m.h2 initial={{y:10, opacity:0.5 }} whileInView={{y:0, opacity:1}} transition={{delay:0.7, type:"tween"}} className="text-2xl smartphone:text-lg text-center smartphone:ml-0 py-3 ibm-plex">Lets create dope stuff together!</m.h2>
        </div>
  ...
  className= {`group flex mt-4 ibm-plexregular hover:text-yellow-500 transition-colors duration-300`}>Email me here<ArrowCircleUpRight className="mx-1 transition-all duration-500  group-hover:translate-x-1 group-hover:-translate-y-1" size={25} weight="duotone" /></a>
       </div>
    </section>
