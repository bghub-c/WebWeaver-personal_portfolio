...
return(
    ...
    <section  id="Footer" className="flex justify-between items-center smartphone:flex-col  border-white mb-4  w-8/12">
        ...
        <motion.h2 initial={{y:10, opacity:0.5 }} whileInView={{y:0, opacity:1}} transition={{delay:0.7, type:"tween"}} className="text-2xl smartphone:text-lg ml-8 smartphone:ml-0 py-3 ibm-plex">Lets create dope stuff together!</motion.h2>
        </div>
